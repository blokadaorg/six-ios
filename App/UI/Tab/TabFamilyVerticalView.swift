...
struct TabFamilyVerticalView: View {
...
struct TabFamilyVerticalView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Group {
            TabFamilyVerticalView(onTap: { _ in })
                .previewLayout(.sizeThatFits)
            TabFamilyVerticalView(vm: packs, onTap: { _ in })
                .previewLayout(.sizeThatFits)
            TabFamilyVerticalView(vm: account, onTap: { _ in })
                .previewLayout(.sizeThatFits)
                .environment(\.colorScheme, .dark)
            TabFamilyVerticalView(vm: inbox, onTap: { _ in })
                .previewLayout(.sizeThatFits)
                .environment(\.colorScheme, .dark)
